    ...
    <ProductShell active="home">
      ...
      <section className="continue-panel section-pad" aria-labelledby="continue-title">
        ...
        <div className="continue-copy">
          ...
          <Link href="/journeys/david/classroom" className="primary-action">Continue <span aria-hidden="true">→</span></Link>
        </div>
      </section>
      ...
      <section className="section-pad split-links">
        <Link href="/academies/bible" className="quiet-card"><span className="eyebrow">Explore</span><strong>Bible Academy</strong><span>Stories, people and ideas that continue to shape the world.</span></Link>
