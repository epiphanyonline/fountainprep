...
export const academyRegistry: AcademyDefinition[] = [
  ...
  tagline:
    "Build practical skills in saving, budgeting, investing, business and responsible money management.",
  icon: "💰",
  ...
  available: true,
    ...
    shortTitle: "AI",
    tagline:
      "Understand artificial intelligence and use it confidently for learning, work and business.",
    icon: "🤖",
  ...
  },
  {
    ...
    shortTitle: "IELTS",
    tagline:
      "Build the speaking, writing, reading and listening skills needed for IELTS success.",
    icon: "🎓",
  ...
  {
    id: "data-analysis",
    title: "Data Analysis Academy",
    shortTitle: "Data Analysis",
    tagline:
      "Learn to investigate data, discover insights and communicate evidence clearly.",
    icon: "📊",
  ...
  {
    id: "articulation",
    title: "Articulation Academy",
    shortTitle: "Articulation",
    tagline:
      "Speak with clarity, confidence, strong pronunciation and persuasive expression.",
    icon: "🎙️",
